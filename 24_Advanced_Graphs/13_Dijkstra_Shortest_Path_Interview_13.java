...
class DijkstraShortestPathInterview13 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int n = rd.nextInt(), m = rd.nextInt(), src = rd.nextInt(), dst = rd.nextInt();
        List<List<E>> g = new ArrayList<>();
        for (int i = 0; i <= n; i++) g.add(new ArrayList<>());
        for (int i = 0; i < m; i++) { int u = rd.nextInt(), v = rd.nextInt(), w = rd.nextInt(); g.get(u).add(new E(v, w)); g.get(v).add(new E(u, w)); }
        long[] d = new long[n + 1];
